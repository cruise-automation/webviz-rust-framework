...
const loadSTLIntoGeometry = async (assetUrl) => {
    await wrflib.initialize({ filename: '/target/wasm32-unknown-unknown/debug/tutorial_rendering_step_2.wasm' });
...
const init = async () => {
    ...
    const geometry = await loadSTLIntoGeometry("/wrflib/examples/tutorial_rendering/teapot.stl");
