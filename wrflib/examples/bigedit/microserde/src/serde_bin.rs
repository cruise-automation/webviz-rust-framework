...
unsafe fn de_bin_array_impl_inner<T>(top: *mut T, count: usize, o: &mut usize, d: &[u8]) -> Result<(), DeBinErr>
where
    T: DeBin,
{
    for c in 0..count {
    ...
    C: DeBin,
{
    fn de_bin(o: &mut usize, d: &[u8]) -> Result<(A, B, C), DeBinErr> {
        Ok((DeBin::de_bin(o, d)?, DeBin::de_bin(o, d)?, DeBin::de_bin(o, d)?))
    }
}
    ...
    D: DeBin,
{
    fn de_bin(o: &mut usize, d: &[u8]) -> Result<(A, B, C, D), DeBinErr> {
        Ok((DeBin::de_bin(o, d)?, DeBin::de_bin(o, d)?, DeBin::de_bin(o, d)?, DeBin::de_bin(o, d)?))
    }
}
