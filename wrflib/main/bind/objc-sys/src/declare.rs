...
impl ClassDecl {
    ...
    */
        ...
        F: MethodImplementation<Callee = Object>,
    {
        ...
        assert!(sel_args == encs.len(), "Selector accepts {} arguments, but function accepts {}", sel_args, encs.len(),);
        ...
        T: Encode,
    {
        ...
        let success = unsafe { runtime::class_addIvar(self.cls, c_name.as_ptr(), size, align, encoding.as_ptr()) };
...
impl ProtocolDecl {
    ...
    fn add_method_description_common<Args, Ret>(&mut self, sel: Sel, is_required: bool, is_instance_method: bool)
    where
