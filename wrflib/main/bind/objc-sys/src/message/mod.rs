...
pub unsafe trait Message {
    ...
    <https://developer.apple.com/library/mac/documentation/Cocoa
        /Reference/ObjCRuntimeRef/index.html#//apple_ref/doc/uid/TP40001418-CH1g-88778>
...
#[inline(always)]
#[cfg(not(feature = "verify_message"))]
pub unsafe fn send_super_message<T, A, R>(obj: *const T, superclass: &Class, sel: Sel, args: A) -> Result<R, MessageError>
where
    T: Message,
    A: MessageArguments,
    R: Any,
    ...
    R: Any + Encode,
{
    ...
    verify_message_signature::<A, R>(superclass, sel).and_then(|_| send_super_unverified(obj, superclass, sel, args))
}
